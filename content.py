...
<section class="section">
  <div class="wrap narrow">
    ...
    <div class="bio" style="margin-top:44px">
      ...
      <div>
        <p>Aviation has become much more than a career for me&mdash;it has become
           something I genuinely love being a part of. As a flight instructor, I have
           had the opportunity to teach both flight and ground school and help
           students work toward their own aviation goals. I strive to grow as a pilot
           and instructor, and I’m excited about building a career in aviation
           while continuing to learn alongside the students I teach. I believe
           aviation is an industry where there is always something new to learn, and
           that mindset is something I bring into every lesson and every flight.</p>
        <p>My interest in aviation started long before I ever thought I would become
           a pilot. Growing up, I was always fascinated by airplanes and loved
           visiting aviation museums, but I never really saw aviation as a career
           path for myself. I originally considered aerospace engineering, but I knew
           I didn’t want to spend my life sitting behind a desk. Everything changed
           when I took a discovery flight with a friend. I fell in love with the
           experience of flying and especially the idea of having an “office in the
           sky.” That flight turned something I had always been interested in into
           something I could actually see myself doing. Going through flight training
           myself also taught me how exciting, challenging, and sometimes overwhelming
           the process can be, and that experience has strongly influenced the way I
           approach teaching.</p>
        <p>My experience is why I want my students to feel like their training is
           personal to them. Everyone learns differently, and everyone comes into
           aviation with a different background, learning style, and goal. Whether
           you are taking your first discovery flight, working toward your Private
           Pilot Certificate, pursuing an instrument rating, or looking toward a
           professional aviation career, my goal is to help you understand not just
           what you’re doing, but why you’re doing it. I want my students to feel
           comfortable asking questions, making mistakes, and learning through the
           process while building the confidence and skills to become safe, capable
           pilots. I know firsthand how much one flight can change the way you see
           your future, and I would love to help you discover where aviation can
           take you.</p>
      </div>
    </div>
  </div>
